...
class account_analytic_line_plan(models.Model):
    ...
    def copy(self, id, default={}):
        ...
        res = super(account_analytic_line_plan, self).copy(id, default)
        return res

    def copy_data(self, id, default={}):
        ...
        res = super(account_analytic_line_plan, self).copy_data(id, default)
        return res

    def on_change_sale_amount(self, id, sale_amount):
    ...
    def get_general_account_id(self, id, prod_id, qty, company_id,
        ...
        if not journal_id:
            j_ids = self.env.get('account.analytic.journal.plan').search([('type', '=', 'sale')])
